...
> Линейное отображение $A$ ТВП $X$  в ТВП $Y$ называется компактным оператором, если существует окрестность нуля $V\in O^{X}$ такая, что множество $A(V)$ относительно компактно в Y.
> 
