...
> [!math|{"type":"definition","number":"auto","setAsNoteMathLink":false,"title":"Формула языка","label":"-","_index":13}] Определение 14 (Формула языка).
...
> [!math|{"type":"definition","number":"auto","setAsNoteMathLink":false,"title":"Связанное вхождение переменной","label":"--","_index":14}] Определение 15 (Связанное вхождение переменной).
> Вхождение переменной в формулу является связанным, если она находится в области действия квантора, ее определяющего.

$$l = \forall x (P(x, y) \to f(z) = r) \; \vee \; T(y) \; \vee R(x, y)$$
> [!math|{"type":"definition","number":"auto","setAsNoteMathLink":true,"title":"Предложение (замкнутая формула)","label":"--","_index":15}] Определение 16 (Предложение (замкнутая формула)).
> Предложение - формула без свободных переменных (только связанные).

> [!math|{"type":"definition","number":"auto","setAsNoteMathLink":false,"title":"Теория","label":"","_index":16}] Определение 17 (Теория).
> Теория  - множество замкнутых формул.

> [!math|{"type":"definition","number":"auto","setAsNoteMathLink":false,"title":"Элементарная теория","label":"-","_index":17}] Определение 18 (Элементарная теория).
> Элементарная теория модели А - множество всех предложений, истинных на $\mathfrak{A}$ .
> Обозначение: $Th \;\mathfrak{A}$

> [!math|{"type":"definition","number":"auto","setAsNoteMathLink":false,"title":"Элементарно эквивалентные модели","label":"--","_index":18}] Определение 19 (Элементарно эквивалентные модели).
> $\mathfrak A$ и $\mathfrak B$ называются элементарно эквивалентными, если $Th$ $\mathfrak{A} = Th \mathfrak{B}$ .
> Обозначение: $\mathfrak A \equiv \mathfrak B$

> [!math|{"type":"theorem","number":"auto","setAsNoteMathLink":false,"_index":19}] Теорема 20.
> $$\mathfrak A \cong \mathfrak{B} \implies \mathfrak{A }\equiv \mathfrak{B}$$

#Упражнение Показать, что обратное в общем случае неверно, однако имеет место быть для конечных моделей (т.е. в случае конечных моделей элементарная эквивалентность равносильна их изоморфности).

> [!math|{"type":"definition","number":"auto","setAsNoteMathLink":false,"title":"Выполнимая формула (в модели)","label":"---","_index":20}] Определение 21 (Выполнимая формула (в модели)).
> Формула $\varphi (x_{1}, \dots, x_{n})$ языка $L$ называется выполнимой в модели $\mathfrak{A}$, если $\exists a_{1}, \dots a_{n}\in \mathfrak{A}$ такие, что
> $$\mathfrak A \vDash \varphi(a_{1}, \dots, a_{n})$$

> [!math|{"type":"definition","number":"auto","setAsNoteMathLink":false,"title":"Выполнимая формула","label":"-","_index":21}] Определение 22 (Выполнимая формула).
> Формула языка $L$ выполнима, если существует модель языка $L$ такая, что эта формула там выполнима.

> [!math|{"type":"definition","number":"auto","setAsNoteMathLink":false,"title":"Опровержимая формула","label":"-","_index":22}] Определение 23 (Опровержимая формула).
> Формула называется опровержимой, если существует модель для формулы $\neg \varphi$.

# Проблема (А. Тарский, 1945 г.)

Свободные неабелевы группы элементарно эквивалентны?

$$F_{r}= <a_{1}, \dots, a_{r}\;|\;\varnothing>$$
Ответ "Да" был дан следующими учеными:
> [!math|{"type":"theorem","number":"","setAsNoteMathLink":false,"_index":0}] Теорема.
> (2007-2009 г., А.Г. Мясников, О.Г, Харлампович, З. Села)
> Свободные неабелевы группы элементарно эквивалентны.

#Упражнение 
Имеют ли место быть следующие изоморфные вложения:
$$<N, \leqslant, +, 0>\widetilde{\subset}<N, \leqslant, \cdot, 1>$$
$$<N, \leqslant, \cdot, 1>\widetilde{\subset}<N, \leqslant, +, 0>$$
$$<N, \leqslant, \cdot, 1>\widetilde{\subset}<N, \leqslant, +, 0>$$
$N = \mathbb{N}\cup \{0\}$
