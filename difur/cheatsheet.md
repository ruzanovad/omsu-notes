...
Исследование вопроса устойчивости некоторого решения y(t) системы 1.17 может быть сведено
к исследованию на устойчивость тривиального решения (точки покоя, положения равновесия)
x(t) ≡ 0 соответствующей системы, получающейся преобразованием исходной к новым переменным
с помощью замены:
x(t) = y(t) − y(t)
